  ...
  \frametitle{Gestione Fallimenti e Sincronia Repliche (II)}
    ...
    \begin{column}{0.4\textwidth}
      ...
      \begin{column}{0.5\textwidth}
        \begin{figure}
        \centering
        \includegraphics[scale=0.07]{dynamo/merkle-tree.png}
        \end{figure}
      \end{column}
    \end{columns}
    \begin{itemize}
...
\begin{frame}
  ...
  \item Dunque non c'è una visione unica e consistente dei nodi falliti, necessario un monitoring periodico.
  \end{itemize}
  \end{block}
...
\begin{frame}
  ...
  \begin{block}{Vantaggi di Dynamo:}
    ...
    \item Consistenza, availability, latency, regolabili appositamente per un'istanza.
    \end{itemize}
  \end{block}
